...
class Redim(_Redim):
    ...
    def replace_dimensions(cls, dimensions, overrides):
        ...
        """
        return super(Redim, cls).replace_dimensions(dimensions, overrides)
    ...
    def cyclic(self, specs=None, **values):
        return super(Redim, self).cyclic(specs, **values)

    def value_format(self, specs=None, **values):
        return super(Redim, self).value_format(specs, **values)

    def range(self, specs=None, **values):
        return super(Redim, self).range(specs, **values)

    def label(self, specs=None, **values):
        return super(Redim, self).label(specs, **values)

    def soft_range(self, specs=None, **values):
        return super(Redim, self).soft_range(specs, **values)

    def type(self, specs=None, **values):
        return super(Redim, self).type(specs, **values)

    def nodata(self, specs=None, **values):
        return super(Redim, self).nodata(specs, **values)

    def step(self, specs=None, **values):
        return super(Redim, self).step(specs, **values)

    def default(self, specs=None, **values):
        return super(Redim, self).default(specs, **values)

    def unit(self, specs=None, **values):
        return super(Redim, self).unit(specs, **values)

    def values(self, specs=None, **ranges):
        return super(Redim, self).values(specs, **ranges)
