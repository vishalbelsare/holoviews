...
from holodata.util import (
    wrap_tuple, unique_iterator, dimension_sort, sanitize_identifier, process_ellipses
)
...
class MultiDimensionalMapping(Dimensioned):
    ...
    def groupby(self, dimensions, container_type=None, group_type=None, **kwargs):
        ...
        with item_check(False):
            ...
            return holodata.util.ndmapping_groupby(self, dimensions, container_type,
...
class UniformNdMapping(NdMapping):
    ...
    data_type = (Dimensioned, NdMapping)
